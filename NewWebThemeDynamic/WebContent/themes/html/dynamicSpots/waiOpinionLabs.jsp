...
<!-- MAIN OL STYLESHEET -->
<link href="<%= baseUrlFromProps %>/NewWebThemeStatic/themes/NewWebTheme/css/oo_style.css" rel="stylesheet" type="text/css" />

<!-- MAIN OL ENGINE -->
<script src="<%= baseUrlFromProps %>/NewWebThemeStatic/themes/NewWebTheme/js/vendor/oo_engine.min.js"></script>

<!-- FEEDBACK CONFIGURATION -->
<script src="<%= baseUrlFromProps %>/NewWebThemeStatic/themes/NewWebTheme/js/vendor/oo_conf.js"></script>
